  ...
  "fixed z-50 gap-4 bg-background shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-300 flex flex-col",
  {
    variants: {
      side: {
        ...
        right:
          "inset-y-0 right-0 h-full w-full sm:max-w-md md:max-w-lg lg:max-w-xl border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right",
      },
    },
...
const SheetHeader = ({
  ...
  <div
    className={cn("flex flex-col space-y-1 px-6 pt-6 pb-4 border-b", className)}
    {...props}
  />
);
...
const SheetFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 border-t px-6 py-4 bg-background",
      className,
    )}
    {...props}
  />
